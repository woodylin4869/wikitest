...
namespace H1_ThirdPartyWalletAPI.Model.Game.NEXTSPIN.Response
{
    public class GetBetHistoryResponse : BaseResponse
    {
        ...
        public class BetInfo
        {
            ...
            public DateTime TicketTimeFormatted { 
                get {
                    //yyyyMMddTHHmmss
                    return DateTime.Parse($"{ticketTime[0..4]}-{ticketTime[4..6]}-{ticketTime[6..8]} {ticketTime[9..11]}:{ticketTime[11..13]}:{ticketTime[13..15]}");
                } 
            }
