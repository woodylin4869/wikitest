...
{
    public interface INEXTSPINApiService
    {
        /// <summary>
        /// 查询转帐记录
        /// 使用场景 ： 查询转帐状态，供核对转帐数据.
        ...
        /// <returns></returns>
        Task<CheckTransferResponse> CheckTransferAsync(CheckTransferRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<GetAcctInfoResponse> GetAcctInfoAsync(GetAcctInfoRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<GetBetHistoryResponse> GetBetHistoryAsync(GetBetHistoryRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<GetDomainListResponse> GetDomainListAsync(GetDomainListRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<KickAcctResponse> KickAcctAsync(KickAcctRequest request);
        ...
        Task<GetReportResponse> GetReportAsync(GetReportRequest request);
    }
}