...
{
    public class Rcg2AuditSchedule : IInvocable
    {
        private readonly ILogger<Rcg2AuditSchedule> _logger;
        private readonly IDBService _dbService;
        private readonly IRepairBetRecordService _repairBetRecordService;
        private const string SYSTEM_PARAMETERS_KEY = "Rcg2AuditSchedule";
        private readonly ISystemParameterDbService _systemParameterDbService;

        public Rcg2AuditSchedule(
            ILogger<Rcg2AuditSchedule> logger,
            ...
            try
            {
                ...
                if (parameter == null)
                {
                    var model = new t_system_parameter()
                    {
                        ...
                        name = "RCG2 每小時遊戲帳務比對排程",
                        description = "RCG2 紀錄帳務比對排程時間基準點"
                    };
