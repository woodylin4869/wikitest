...
{
    public class Rcg3AuditSchedule : IInvocable
    {
        private readonly ILogger<Rcg3AuditSchedule> _logger;
        private readonly IDBService _dbService;
        private readonly IRepairBetRecordService _repairBetRecordService;
        private const string SYSTEM_PARAMETERS_KEY = "Rcg3AuditSchedule";
        private readonly ISystemParameterDbService _systemParameterDbService;

        public Rcg3AuditSchedule(
            ILogger<Rcg3AuditSchedule> logger,
            ...
            try
            {
                ...
                if (parameter == null)
                {
                    var model = new t_system_parameter()
                    {
                        ...
                        name = "RCG3 每小時遊戲帳務比對排程",
                        description = "RCG3 紀錄帳務比對排程時間基準點"
                    };
                ...
                {
                    game_id = Platform.RCG3.ToString(),
