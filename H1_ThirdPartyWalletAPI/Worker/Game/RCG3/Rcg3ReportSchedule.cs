...
{
    public class Rcg3ReportSchedule : IInvocable
    {
        private readonly ILogger<Rcg3ReportSchedule> _logger;
        private readonly IDBService _dbService;
        private readonly IRCG3InterfaceService _apiInterfaceService;
        private readonly ISystemParameterDbService _systemParameterDbService;
        private const string SYSTEM_PARAMETERS_KEY = "Rcg3ReportSchedule";

        public Rcg3ReportSchedule(
            ILogger<Rcg3ReportSchedule> logger,
            ...
            try
            {
                ...
                if (parameter == null)
                {
                    var model = new t_system_parameter()
                    {
                        ...
                        name = "RCG3每小時遊戲匯總報表排程",
                        description = "RCG3紀錄排程時間基準點"
                    };
                ...
                // 產生Game RCG3 每小時報表 ... RCG3 非H1特規 未提供
