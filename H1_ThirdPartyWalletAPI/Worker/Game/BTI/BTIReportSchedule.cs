...
{
    public class BTIReportSchedule : IInvocable
    {
        private readonly ILogger<BTIReportSchedule> _logger;
        private readonly IDBService _dbService;
        private readonly IBTIInterfaceService _apiInterfaceService;
        private readonly ISystemParameterDbService _systemParameterDbService;
        private const string SYSTEM_PARAMETERS_KEY = "BTIReportSchedule";

        public BTIReportSchedule(
            ILogger<BTIReportSchedule> logger,
