...
{
    public class WS168ReportSchedule : IInvocable
    {
        private readonly ILogger<WS168ReportSchedule> _logger;
        private readonly IWS168InterfaceService _apiInterfaceService;
        private readonly ICommonService _commonService;
        private readonly ISystemParameterDbService _systemParameterDbService;
        public WS168ReportSchedule(ILogger<WS168ReportSchedule> logger,
            IWS168InterfaceService apiInterfaceService,
        ...
        public async Task Invoke()
       {
            ...
            _logger.LogInformation("Invoke WS168ReportSchedule on time : {time}", DateTime.Now);
            ...
            try
            {
                ...
                if (parameter == null)
                {
                    var model = new t_system_parameter()
                    {
                        ...
                        name = "WS168 每小時遊戲匯總報表排程",
                        description = "WS168 紀錄排程時間基準點"
                    };
                ...
                else
                {
                    ...
                    {
                        _logger.LogInformation("WS168 report stop time: {time}", parameter.value);
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError("Run WS168 report schedule exception EX : {ex}  MSG : {Message}  Error Line : {errorFile}.{errorLine}", ex.GetType().FullName, ex.Message, errorFile, errorLine);
            }
        }
    }
}
